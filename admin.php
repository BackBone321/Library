...
// Generate CSRF token if not existsclear
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand" href="?page=home">
                <i class="fas fa-book-reader"></i> Library Hub
            </a>
    ...
    <div class="container mt-4">
        ...
        <?php if ($page === 'home' || $page === ''): ?>
            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="stats-card stats-borrowed">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="stats-card stats-overdue">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label  for="showOnlyAvailable">Show only available books</label>
                                                </div>
                                            </div>
                                        </div>
